...
import imgage from '../../assets/images/nftItemsImgs/nft_item_10.png';
import {Link} from 'react-router-dom';
import {useSelector} from 'react-redux'

function NftItem({ img, title, text, span_text, likes_amount, with_fire, itemId }: NftItemsInterface) {
    return (
        <Link to={`/item/${itemId}`}>
        <div className={classes.NftItemWrapper}>
            <div className={classes.NftItem}>
                ...
                <div className={classes.nft_item_img}>
                    <img src={require(`../../assets/images/nftItemsImgs/${img}.png`)} alt={title} />
                </div>
                {
